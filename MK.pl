...
#
#		-returns MK test counts and pvalue from Fisher's Exact Test
...
#		-file names within the specified directory should be *.fa
#
#		usage at the bottom of this file shows how to run script
#
#		NOTE:  you will need to have the module Text::NSP to use the FET
#
#		please send any questions|error reports to alisha@frombits.com
#
###########################################################################
...
## currently this script counts polymorphisms for ingroup
